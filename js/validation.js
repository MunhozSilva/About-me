...
const mensagensDeErro = {
    ...
    email: {
        ...
        typeMismatch: 'Email entered is not valid.'
    }, 
    company_name: {
        valueMissing: 'Company name field cannot be empty.'
    },
    company_field: {
        valueMissing: 'Company field cannot be empty.'
    },       
    cidade: {
        valueMissing: 'Company city field cannot be empty.'
    },
    estado: {
        valueMissing: 'Company state field cannot be empty.'
    },
    message: {
